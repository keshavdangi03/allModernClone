          ...
          <div className="mt-12 bg-white">
            <div className="flex flex-col md:flex-row items-baseline justify-between border-b border-slate-300 pb-4 mb-6">
              <div className="flex items-end gap-2">
                <h2 className="text-[28px] md:text-[34px] font-bold tracking-[-0.02em] text-slate-900">Bedding</h2>
                <span className="pb-1.5 text-[14px] text-slate-500">908 Items</span>
              </div>
              <div className="flex items-center gap-4 mt-4 md:mt-0 w-full md:w-auto">
                ...
                <div className="flex-1 md:flex-none relative flex items-center gap-2">
                  <span className="text-[14px] text-slate-500 hidden md:block">Sort By</span>
                  <div className="relative flex-1 md:flex-none">
                    <select className="w-full h-10 border border-slate-400 bg-white px-3 text-[14px] text-slate-700 appearance-none pr-8 hover:bg-slate-50 transition-colors cursor-pointer min-w-[160px]">
