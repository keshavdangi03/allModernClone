...
export default function TermsConditionsPage() {
  const [title, setTitle] = useState("Terms and Conditions of Use");
  const [subtitle, setSubtitle] = useState("Welcome to Cozy commerce (\"we\", \"our\", or \"us\"). These Terms and Conditions govern your use of our website, mobile application, and service");
  const [content, setContent] = useState("1. Introduction\nWelcome to NextMerce (\"we\", \"our\", or \"us\"). These Terms and Conditions govern your use of our website, mobile application, and services (collectively, the \"Services\").\nBy accessing or using our Services, you agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use our Services.\n2. Account Registration\nTo access certain features of our Services, you may be required to register for an account. You agree to provide accurate, current, and complete information...");
