...
const connectionString = process.env.DATABASE_URL || "postgresql://neondb_owner:npg_Cq5f2oXJUYiQ@ep-snowy-dust-ao57p5ia-pooler.c-2.ap-southeast-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require";
